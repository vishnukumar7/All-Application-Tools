...
import com.example.allapps.genericFile.utils.recyclerViewPagerImageIndicator;
 ...
 * Author: CodeBoy722
 * <p>
 * this fragment handles the browsing of all images in an ArrayList of AllFacer passed in the constructor
...
public class pictureBrowserFragment extends Fragment implements imageIndicatorListener {
    ...
    private ArrayList<AllFacer> allImages = new ArrayList<>();
    ...
    public pictureBrowserFragment(ArrayList<AllFacer> allImages, int imagePosition, Context anim) {
        this.allImages = allImages;
        this.position = imagePosition;
        this.animeContx = anim;
    }

    public static pictureBrowserFragment newInstance(ArrayList<AllFacer> allImages, int imagePosition, Context anim) {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        imagePager.setCurrentItem(position);//displaying the image at the current position passed by the FileDisplay Activity
    ...
    private class ImagesPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(@NonNull ViewGroup containerCollection, int position) {
            ...
            AllFacer pic = allImages.get(position);
